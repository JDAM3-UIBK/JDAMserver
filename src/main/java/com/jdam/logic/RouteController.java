 ...
 * Controller für das Abfragen der einzelnen Routen
 */
public class RouteController {

	/**
	 * {@value} Anzahl der Fortbewegungsmittel
	 */
	...
	/**
	 * 
	 * @param origin Start der Route als String
	 * @param destination Ziel der Route als String
	 * @return Routenarray mit den 3 Unterschiedlichen Fortbewegungsmitteln
	 */
...
System.out.println("str");
	...
	/**
	 * 
	 * @param origin Start der Route als LatLng
	 * @param destination Ziel der Route als String
	 * @return Routenarray mit den 3 Unterschiedlichen Fortbewegungsmitteln
	 */
	 ...
	 * 
	 * @param origin Start der Route als LatLng
	 * @param destination Ziel der Route als LatLng
	 * @return Routenarray mit den 3 Unterschiedlichen Fortbewegungsmitteln
	 */
...
System.out.println("calc latlng");
	...
	/**
	 * 
	 * @param task Task der das Abfragen der einzelnen Route beinhaltet
