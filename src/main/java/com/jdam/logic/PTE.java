...
public class PTE implements Callable<Route>{
	...
	/**
	 * Konstruktor für die Routenabfrage
	 * @param start
	 * @param stop
	...
	/**
	 * Routenberechnung für die Oeffentlichen
	 * @return Route der oeffentlichen Verkehrsmittel
	 */
...
//			int distance = -1;
	...
	/**
	 * Liefert formatierten String-Array für die Umstiege bei den oeffentlichen Verkehrsmitteln zurück.
	 * @param qt Route die vom PTE zurückkommt
	 * @return String-Array mit Fahrplan
	 */
	 ...
	 * @param qtr Route die vom PTE zurückkommt
	 * @return liefert die Distanz der Strecke in Metern zurück
	 */
...
/**
 * Implementation des Callable Interfaces zur Berechnung einer Route mit den oeffentlichen Verkehrsmitteln
 */
	@Override
